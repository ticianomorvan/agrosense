...
Workers, and shared Zod contracts. It supports browser sign-in and onboarding,
authenticated dashboard reads, Open-Meteo forecast refresh/publication, and
rule-based crop-risk evaluation. Live evaluations require approved rules.
